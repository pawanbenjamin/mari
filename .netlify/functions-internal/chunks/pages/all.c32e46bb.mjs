...
const $$Treatments = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "treatments" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "PageHeader", $$PageHeader, { "title": "treatment", "desc": "methods", "next": "faq", "prev": "services" })}${maybeRenderHead($$result2)}<main class="mx-auto max-w-page px-6 py-12 md:py-16">
    <div class="mx-auto max-w-reading space-y-12">
      ...
      <section>
        <figure class="mb-6 overflow-hidden rounded-md aspect-[4/3] bg-sage-50 shadow-sm shadow-sage-900/5">
...
const $$ServiceBlock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${imageUrl !== "" && renderTemplate`<figure class="mb-6 overflow-hidden rounded-md bg-sage-50 aspect-[4/3] shadow-sm shadow-sage-900/5">
        ${renderComponent($$result, "CldImage", $$CldImage, { "src": imageUrl, "alt": title, "height": "auto", "width": "auto", "class": "h-full w-full object-cover saturate-[.85] contrast-[1.05]" })}
      </figure>`}

  <details class="group">
    <summary class="flex items-baseline justify-between gap-4 cursor-pointer list-none text-ink hover:text-sage-600 transition-colors">
      <span class="flex items-baseline gap-4 min-w-0">
        ${number && renderTemplate`<span class="font-sans text-xs tracking-widest text-sage-500 shrink-0 tabular-nums">
              ${number}
            </span>`}
        <span class="font-display text-2xl md:text-3xl font-light tracking-tightish">
          ${title}
        </span>
      </span>
      <span class="shrink-0 text-sage-500 text-xl transition-transform group-open:rotate-45" aria-hidden="true">+</span>
    </summary>
