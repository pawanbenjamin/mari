...
const $$ServiceBlock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<article class="service-block flow-root border-b border-sage-100 py-10 first:pt-0 last:border-b-0">
  ${imageUrl !== "" && renderTemplate`<figure class="mb-6 md:mb-2 md:mr-6 md:float-left md:w-56 lg:w-64 aspect-[4/3] overflow-hidden rounded-md bg-sage-50 shadow-sm shadow-sage-900/5">
  ...
  <h3 class="flex items-baseline gap-4 text-ink">
  ...
  <p class="mt-4 text-ink-soft leading-relaxed">${desc}</p>

  ${treatmentList && treatmentList.length > 0 && renderTemplate`<details class="mt-6 md:clear-left pl-4 border-l-2 border-sage-200">
