...
const $$ServiceBlock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="md:flex md:gap-6 lg:gap-8 md:items-center">
    ${imageUrl !== "" && renderTemplate`<figure class="mb-6 md:mb-0 md:w-56 lg:w-64 md:shrink-0 md:self-start aspect-[4/3] overflow-hidden rounded-md bg-sage-50 shadow-sm shadow-sage-900/5">
