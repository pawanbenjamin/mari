...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="mx-auto max-w-page px-6 py-4 flex items-center justify-between astro-3EF6KSR2">
    <a href="/" class="font-display text-lg md:text-xl tracking-tightish font-normal astro-3EF6KSR2">
    ...
    <div class="flex items-center gap-6 astro-3EF6KSR2">
      ...
      <button id="menu-toggle" aria-label="Toggle menu" aria-expanded="false" class="hamburger relative w-8 h-8 flex items-center justify-center astro-3EF6KSR2">
        <span class="hamburger-bar astro-3EF6KSR2"></span>
      </button>
    </div>
  </div>

  <nav id="overlay-menu" class="overlay-menu fixed inset-0 z-40 bg-cream-100 pointer-events-none opacity-0 transition-opacity duration-300 astro-3EF6KSR2">
    <div class="h-full flex items-center justify-center astro-3EF6KSR2">
      <ul class="flex flex-col gap-6 text-center astro-3EF6KSR2">
        <li class="astro-3EF6KSR2">
          <a href="/" class="font-display text-3xl md:text-4xl font-light tracking-tightish hover:text-sage-600 astro-3EF6KSR2">home</a>
        </li>
        <li class="astro-3EF6KSR2">
          <a href="/about" class="font-display text-3xl md:text-4xl font-light tracking-tightish hover:text-sage-600 astro-3EF6KSR2">about</a>
        </li>
        <li class="astro-3EF6KSR2">
          <a href="/services" class="font-display text-3xl md:text-4xl font-light tracking-tightish hover:text-sage-600 astro-3EF6KSR2">services</a>
        </li>
        <li class="astro-3EF6KSR2">
          <a href="/treatments" class="font-display text-3xl md:text-4xl font-light tracking-tightish hover:text-sage-600 astro-3EF6KSR2">treatments</a>
        </li>
        <li class="astro-3EF6KSR2">
          <a href="/faq" class="font-display text-3xl md:text-4xl font-light tracking-tightish hover:text-sage-600 astro-3EF6KSR2">faq</a>
        </li>
        <li class="astro-3EF6KSR2">
          <a href="/contact" class="font-display text-3xl md:text-4xl font-light tracking-tightish hover:text-sage-600 astro-3EF6KSR2">contact</a>
        </li>
      </ul>
    </div>
  </nav>
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to Mariposa Wellness LLC Integrative Manual Therapy & Pelvic Health" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "PageHeader", $$PageHeader, { "title": "Integrative Manual Therapy", "desc": "& Pelvic Health", "next": "about", "prev": "services" })}${maybeRenderHead($$result2)}<main class="mx-auto max-w-page px-6 py-12 md:py-16">
    <figure class="relative overflow-hidden rounded-sm">
      ${renderComponent($$result2, "CldImage", $$CldImage, { "src": "mari/eight_lmmlwq.jpg", "alt": "Marisa with patient", "width": "auto", "height": "auto" })}
    ...
    <div class="mx-auto max-w-reading space-y-12">
      ...
      <section>
        <figure class="mb-6 overflow-hidden rounded-sm">
          ${renderComponent($$result2, "CldImage", $$CldImage, { "src": "mari/stom2_u3amcw.jpg", "width": "auto", "height": "auto", "alt": "Marisa and patient" })}
        </figure>
        <h2 class="font-display text-3xl md:text-4xl font-light tracking-tightish text-ink mb-4">
        ...
        <p class="text-ink-soft leading-relaxed">
          ...
          sexual dysfunction, pain, and more. Also, because the pelvic floor is
          one of our core muscles in can often be a missing link in persistent
      ...
      <section>
        <figure class="mb-6 overflow-hidden rounded-sm">
          ${renderComponent($$result2, "CldImage", $$CldImage, { "src": "mari/four-1_fmzwof.jpg", "width": "auto", "height": "auto", "alt": "Marisa and patient" })}
        </figure>
        <h2 class="font-display text-3xl md:text-4xl font-light tracking-tightish text-ink mb-4">
          myofascial release
        </h2>
...
const $$ServiceBlock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<article class="service-block border-b border-sage-100 py-10 first:pt-0 last:border-b-0">
  ${imageUrl !== "" && renderTemplate`<figure class="mb-6 overflow-hidden rounded-sm">
        ${renderComponent($$result, "CldImage", $$CldImage, { "src": imageUrl, "alt": title, "height": "auto", "width": "auto" })}
      </figure>`}

  <details class="group">
    <summary class="flex items-center justify-between cursor-pointer list-none font-display text-2xl md:text-3xl font-light tracking-tightish text-ink hover:text-sage-600 transition-colors">
      <span>${title}</span>
      <span class="ml-4 text-sage-500 text-xl transition-transform group-open:rotate-45" aria-hidden="true">+</span>
    </summary>

    <div class="mt-5 space-y-5">
      <p class="text-ink-soft leading-relaxed">${desc}</p>

      ${treatmentList && treatmentList.length > 0 && renderTemplate`<details class="pl-4 border-l-2 border-sage-200">
            <summary class="cursor-pointer list-none font-sans text-xs uppercase tracking-widest text-sage-600 hover:text-sage-700">
              ${listLabel} &rarr;
            </summary>
            <ul class="mt-3 grid gap-1.5 text-sm text-ink-soft sm:grid-cols-2">
              ${treatmentList.map((treatment) => renderTemplate`<li class="flex gap-2">
                  <span class="text-sage-400" aria-hidden="true">
                    ·
                  </span>
                  <span>${treatment}</span>
                </li>`)}
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "contact" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "PageHeader", $$PageHeader, { "title": "", "desc": "contact", "next": "home", "prev": "faq" })}${maybeRenderHead($$result2)}<main class="mx-auto max-w-page px-6 py-12 md:py-16">
    <div class="mx-auto max-w-reading grid gap-10 md:grid-cols-2">
      ...
      <section class="rounded-sm border border-sage-100 bg-cream-50 p-8 flex flex-col gap-6">
        ...
        <a href="mailto:admin@mariposawellnessllc.com" class="btn-ghost break-all">
...
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "About Me" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "PageHeader", $$PageHeader, { "title": "Marisa", "desc": "she/ella", "next": "services", "prev": "home" })}${maybeRenderHead($$result2)}<main class="mx-auto max-w-page px-6 py-12 md:py-16">
    <figure class="relative overflow-hidden rounded-sm">
      ${renderComponent($$result2, "CldImage", $$CldImage, { "src": "mari/mari-karuna_gnlu1y.webp", "alt": "Marisa", "height": "auto", "width": "auto" })}
      <figcaption class="absolute inset-x-0 bottom-0 p-6 md:p-10 bg-gradient-to-t from-black/60 via-black/20 to-transparent">
        <h2 class="font-display font-light tracking-tightish text-3xl md:text-5xl leading-none text-cream-50">
          marisa
        </h2>
      </figcaption>
    ...
    <article class="mx-auto mt-12 md:mt-16 max-w-reading prose-body space-y-6">
      <p>
      ...
      <blockquote class="my-10 border-l-2 border-sage-400 pl-6 py-2 font-display text-xl md:text-2xl italic font-light text-sage-700 leading-snug">
      ...
      <p>
        ...
        ergonomics, pre and postpartum wellness, to sexual health throughout
        the lifespan.
      </p>
    </article>
  </main>` })}`;
